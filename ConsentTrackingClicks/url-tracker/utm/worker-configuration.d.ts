/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c135c22f77da30fe1f58fe2c1f8205e3)
// Runtime types generated with workerd@1.20250416.0 2025-04-19 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SITE_NAME: "UTM TRACKING";
		REDIRECT_DELAY: "3";
		DATABASE_URL: "postgresql://Neon_owner:npg_q6WrRLGKAkN8@ep-little-bar-a1yo017r.ap-southeast-1.aws.neon.tech/Neon?sslmode=require";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_NAME" | "REDIRECT_DELAY" | "DATABASE_URL">> {}
}
